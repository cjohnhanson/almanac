...
The published name is `lmnc`, because `almanac` was taken. Both commands
install together. Type `almanac`.
...
[releases page](https://github.com/cjohnhanson/almanac/releases) holds all
of them.
